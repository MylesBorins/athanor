...
const KEYS: KeySpec[] = [
  ...
  { runtime: "llama.cpp", jsonName: "cacheRam", type: "number",
    aliases: ["cacheRam", "cache-ram", "cram"],
    parse: num, help: "llama: maximum prompt cache size in MiB (default: 8192, 0 = disabled, -1 = unlimited)" },
